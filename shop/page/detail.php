						...
						<div class="col-md-4" >
							...
							<div class="single-item-body" align="center">
								<p class="single-item-title"><h2> <?= $productdetail['proname']; ?> </h2></p></div>
                                 ...
                                 <?php
                                 if($productdetail['condition']=="in stock" && isset($_SESSION['username'])) {
                                 ...
                                 <?php 
                                  ...
                                  else if($productdetail['condition']=="out of stock"){
                                  	?>
                                  	   <script type="text/javascript"> alert("product is out of stock"); </script>
                                  	   <a href ="index.php?page=detail&ID=<?= $productdetail['id_product'] ?>" class="btn btn-danger" title="cart">add to cart </a>
                                    <?php
                                  }

                                   else if(!isset($_SESSION['username'])) {
                                  	?>
                                  	   <script type="text/javascript"> alert("please log in if you want to add products to cart!"); </script>
                                  	   <a href ="index.php?page=detail&ID=<?= $productdetail['id_product'] ?>" class="btn btn-danger" title="cart">add to cart </a>
                                    <?php
                                  }
